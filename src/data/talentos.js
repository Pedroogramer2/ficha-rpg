...
export const TALENTOS = {
  ...
  "Artesão": { 
    ...
    categoria: "Origem",
    pendencias: ["Escolher 3 Ferramentas de Artesão"],
  ...
  "Iniciado em Magia": {
    ...
    categoria: "Origem",
    pendencias: ["Escolher 2 Truques", "Escolher 1 Magia (Nível 1)", "Escolher Atributo de Conjuração"],
  ...
  "Músico": {
    ...
    categoria: "Origem",
    pendencias: ["Escolher 3 Instrumentos Musicais"],
  ...
  "Habilidoso": {
    ...
    categoria: "Origem",
    pendencias: ["Escolher 3 Perícias ou Ferramentas"],
  ...
  "Robustez": { 
    nome: "Robustez (Tough)",
    categoria: "Origem",
    efeitosPassivos: { vidaPorNivel: 2 },
  ...
  "Agente dos Harpistas": {
    ...
    categoria: "Origem",
    pendencias: ["Escolher 1 Instrumento Musical"],
  ...
  "Recruta do Dragão Púrpura": {
    ...
    categoria: "Origem",
    pendencias: ["Escolher 1 Perícia (Intuição, Performance ou Persuasão)"],
  ...
  "Melhoria de Atributo": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 2, opcoes: ["forca", "destreza", "constituicao", "inteligencia", "sabedoria", "carisma"] },
  ...
  "Ator": {
    nome: "Ator (Actor)",
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["carisma"] },
  ...
  "Atleta": {
    nome: "Atleta (Athlete)",
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["forca", "destreza"] },
  ...
  "Cozinheiro": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["constituicao", "sabedoria"] },
  ...
  "Especialista em Besta": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["destreza"] },
  ...
  "Esmagador": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["forca", "constituicao"] },
  ...
  "Durável": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["constituicao"] },
  ...
  "Adepto Elemental": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["inteligencia", "sabedoria", "carisma"] },
  ...
  "Tocado pelas Fadas": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["inteligencia", "sabedoria", "carisma"] },
    pendencias: ["Escolher 1 Magia (Nv 1 - Adivinhação/Encantamento)"],
  ...
  "Mestre de Armas Grandes": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["forca"] },
  ...
  "Líder Inspirador": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["sabedoria", "carisma"] },
  ...
  "Mente Aguçada": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["inteligencia"] },
    pendencias: ["Escolher 1 Perícia (Conhecimento)"],
  ...
  "Observador": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["inteligencia", "sabedoria"] },
    pendencias: ["Escolher 1 Perícia (Busca)"],
  ...
  "Envenenador": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["destreza", "inteligencia"] },
  ...
  "Resiliente": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["forca", "destreza", "constituicao", "inteligencia", "sabedoria", "carisma"] },
    pendencias: ["Escolher 1 Proficiência em Teste de Resistência"],
  ...
  "Conjurador de Ritual": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["inteligencia", "sabedoria", "carisma"] },
    pendencias: ["Escolher Magias de Ritual (Qtd = Proficiência)"],
  ...
  "Tocado pelas Sombras": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["inteligencia", "sabedoria", "carisma"] },
    pendencias: ["Escolher 1 Magia (Nv 1 - Ilusão/Necromancia)"],
...
"Mestre de Escudos": {
  ...
  "Especialista em Perícia": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["forca", "destreza", "constituicao", "inteligencia", "sabedoria", "carisma"] },
    pendencias: ["Escolher 1 Perícia (Prof)", "Escolher 1 Perícia (Especialização)"],
  ...
  "Veloz": {
    nome: "Veloz (Speedy)",
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["destreza", "constituicao"] },
    efeitosPassivos: { bonusDeslocamento: 10 },
  ...
  "Mestre de Armas": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["forca", "destreza"] },
    pendencias: ["Escolher 1 Maestria em Arma"],
  ...
  "Marcado pelo Dragão": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["constituicao", "carisma"] },
    pendencias: ["Escolher 1 Resistência (Ácido, Frio, Fogo, Elétrico ou Veneno)"],
  ...
  "Trapaceiro Feérico": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["destreza", "carisma"] },
  ...
  "Determinação Senhorial": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["forca", "carisma"] },
  ...
  "Resiliência da Ordem": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["forca", "sabedoria", "carisma"] },
  ...
  "Táticas Zhentarim": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["destreza", "carisma"] },
    pendencias: ["Escolher 1 Perícia (Especialização)"],
  ...
  "Sedento de Sangue": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["forca", "destreza", "constituicao"] },
  ...
  "Tocado pelo Vampiro": {
    ...
    categoria: "Geral",
    aumentaAtributo: { qtd: 1, opcoes: ["inteligencia", "sabedoria", "carisma"] },
    pendencias: ["Escolher 1 Magia (Nv 1 - Encantamento/Ilusão)"],
  ...
  "Dádiva da Resistência a Energia": {
    ...
    categoria: "Épico",
    aumentaAtributo: { qtd: 1, opcoes: ["forca", "destreza", "constituicao", "inteligencia", "sabedoria", "carisma"] },
    pendencias: ["Escolher 2 Resistências a Energia"],
  ...
  "Dádiva da Fortitude": {
    ...
    categoria: "Épico",
    aumentaAtributo: { qtd: 1, opcoes: ["forca", "destreza", "constituicao", "inteligencia", "sabedoria", "carisma"] },
    efeitosPassivos: { bonusVidaMaxima: 40 },
  ...
  "Dádiva da Velocidade": {
    ...
    categoria: "Épico",
    aumentaAtributo: { qtd: 1, opcoes: ["forca", "destreza", "constituicao", "inteligencia", "sabedoria", "carisma"] },
    efeitosPassivos: { bonusDeslocamento: 30 },
  ...
  "Dádiva de Siberys": {
    ...
    categoria: "Épico",
    aumentaAtributo: { qtd: 1, opcoes: ["forca", "destreza", "constituicao", "inteligencia", "sabedoria", "carisma"] },
    pendencias: ["Escolher 1 Magia de Nível 8 (Feiticeiro ou Marca)"],
  ...
  "Alma Ecoante": {
    ...
    categoria: "Geral",
    pendencias: ["Escolher 2 Perícias (Prof)", "Escolher 1 Perícia (Especialização)", "Escolher 1 Idioma"],
  ...
  "Ser Simbiótico": {
    ...
    categoria: "Geral",
    pendencias: ["Escolher 1 Perícia (Conhecimento ou Interação)", "Escolher 1 Idioma"],
